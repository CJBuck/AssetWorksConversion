...
/****** Object:  Table [dbo].[TargetTestResultsDetails]    Script Date: 12/14/2015 13:38:19 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TargetTestResultsDetails]') AND TYPE IN(N'U'))
DROP TABLE [dbo].[TargetTestResultsDetails]
GO
...
CREATE TABLE [dbo].[TargetTestResultsDetails](
	[Control] [varchar](10) NOT NULL,
	[TestID] [varchar](9) NOT NULL,
	[TestElementID] [varchar](20) NOT NULL,
