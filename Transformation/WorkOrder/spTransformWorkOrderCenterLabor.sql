...
--	=================================================================================================
	...
	FROM SourceWicm251WorkOrderDetailLaborCharges DLP
		...
		INNER JOIN TransformWorkOrderDistOpCode doc ON ha.OP_CODE1 = doc.OpCode
	...
	FROM SourceWicm251WorkOrderDetailLaborCharges DLP
		INNER JOIN SourceWicm250WorkOrderHeaderAdmin ha ON DLP.WO_NUMBER = ha.WO_NUMBER
		INNER JOIN TransformWorkOrderCenter woc ON DLP.WO_NUMBER = woc.WorkOrderNumber
		INNER JOIN TransformWorkOrderDistOpCode doc ON ha.OP_CODE2 = doc.OpCode
	...
	FROM SourceWicm251WorkOrderDetailLaborCharges DLP
		INNER JOIN SourceWicm250WorkOrderHeaderAdmin ha ON DLP.WO_NUMBER = ha.WO_NUMBER
		INNER JOIN TransformWorkOrderCenter woc ON DLP.WO_NUMBER = woc.WorkOrderNumber
		INNER JOIN TransformWorkOrderDistOpCode doc ON ha.OP_CODE3 = doc.OpCode
	WHERE ISNULL(ha.OP_CODE3, '') <> ''

	---- WorkOrderAdmin - DetailLaborCharges
	INSERT INTO [tmp].[WorkOrderCenterLabor]
	SELECT DISTINCT woc.WorkOrderLocationID, woc.WorkOrderYear, woc.WorkOrderNumber,
		doc.TaskIDAlignment,
		CASE
	...
	FROM SourceWicm251WorkOrderDetailLaborCharges DLP
		...
		INNER JOIN TransformWorkOrderCenter woc ON DLP.WO_NUMBER = woc.WorkOrderNumber
		INNER JOIN TransformWorkOrderDistOpCode doc ON hp.OP_CODE1 = doc.OpCode
	...
	FROM SourceWicm251WorkOrderDetailLaborCharges DLP
		INNER JOIN SourceWicm250WorkOrderHeaderProjects hp ON DLP.WO_NUMBER = hP.WO_NUMBER
		INNER JOIN TransformWorkOrderCenter woc ON DLP.WO_NUMBER = woc.WorkOrderNumber
		INNER JOIN TransformWorkOrderDistOpCode doc ON hp.OP_CODE2 = doc.OpCode
	...
	FROM SourceWicm251WorkOrderDetailLaborCharges DLP
		INNER JOIN SourceWicm250WorkOrderHeaderProjects hp ON DLP.WO_NUMBER = hP.WO_NUMBER
		INNER JOIN TransformWorkOrderCenter woc ON DLP.WO_NUMBER = woc.WorkOrderNumber
		INNER JOIN TransformWorkOrderDistOpCode doc ON hp.OP_CODE3 = doc.OpCode
	WHERE ISNULL(hp.OP_CODE3, '') <> ''

	---- WorkOrderProjects - DetailLaborCharges
	INSERT INTO [tmp].[WorkOrderCenterLabor]
	SELECT DISTINCT woc.WorkOrderLocationID, woc.WorkOrderYear, woc.WorkOrderNumber,
		doc.TaskIDAlignment,
		CASE
	...
	---- WorkOrderVehiclesNewSvcInstallRepair - DetailLaborCharges
	INSERT INTO [tmp].[WorkOrderCenterLabor]
	SELECT DISTINCT woc.WorkOrderLocationID, woc.WorkOrderYear, woc.WorkOrderNumber,
		doc.TaskIDAlignment,
		CASE
