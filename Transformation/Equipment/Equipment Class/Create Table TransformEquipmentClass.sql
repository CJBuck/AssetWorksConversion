...
SELECT
	...
	ISNULL(csv.ComebackRangeDays, NULL) [ComebackRange],
	ISNULL(csv.PMSoonDueDays, NULL) [PMSoonDue],
	...
	LEFT(LTRIM(RTRIM(csv.ValueDepreciationID)), 8) [ValueDepreciationID],
	LEFT(LTRIM(RTRIM(csv.[Meter types])), 1) [MeterTypes],
