...
/****** Object:  Table [dbo].[TargetEquipmentClassPMDetail]    Script Date: 05/22/2015 08:00:35 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TargetEquipmentClassPMDetail]') AND type in (N'U'))
DROP TABLE [dbo].[TargetEquipmentClassPMDetail]
GO

/****** Object:  Table [dbo].[TargetEquipmentClassPMDetail]    Script Date: 05/22/2015 08:00:36 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[TargetEquipmentClassPMDetail](
