...
/****** Object:  Table [dbo].[TransformLinearAsset]    Script Date: 07/16/2015 10:32:45 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[TransformLinearAsset]') AND TYPE IN (N'U'))
DROP TABLE [dbo].[TransformLinearAsset]
GO
...
CREATE TABLE [dbo].[TransformLinearAsset](
